...
public class PlantItem : MonoBehaviour
{
    ...
    {
        totalGrowTime =
            Mathf.RoundToInt(plant.timeBetweenStages) *
            plant.plantStages.Length; // getting total grow time
        IntializeUI();
    }
    ...
    void IntializeUI()
    {
        ...
        iconBackground.sprite = plant.iconBackground;
        iconBackground.color = plant.iconBackgroundColor;
